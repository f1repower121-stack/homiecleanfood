...
export default function Footer() {
  ...
  return (
    <footer className="bg-homie-green text-white mt-0 border-t border-homie-green/80">
      <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        {/* Brand */}
        <div className="md:col-span-2">
          <h3 className="font-semibold text-xl mb-2">Homie Clean Food</h3>
          ...
          <Link href="/qr" className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 rounded-lg px-3 py-2 transition-colors mb-4">
          ...
          <div className="flex gap-3">
            <a href="https://web.facebook.com/homiecleanfood" target="_blank" rel="noreferrer"
              className="w-9 h-9 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-colors text-sm font-bold">f</a>
            <a href="https://www.instagram.com/homiecleanfood/" target="_blank" rel="noreferrer"
              className="w-9 h-9 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-colors text-xs font-bold">ig</a>
            <a href="https://line.me/R/ti/p/%40homiecleanfood" target="_blank" rel="noreferrer"
              className="w-9 h-9 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-colors text-xs font-bold">L</a>
          </div>
        </div>

        {/* Quick Links */}
        <div>
          <h4 className="font-semibold mb-3 text-emerald-200/90">Quick Links</h4>
        ...
        {/* Contact */}
        <div>
          <h4 className="font-semibold mb-3 text-emerald-200/90">Contact</h4>
          <ul className="space-y-2 text-sm text-emerald-200/90">
      ...
      <div className="border-t border-white/10 text-center py-4 text-emerald-200/80 text-xs">
